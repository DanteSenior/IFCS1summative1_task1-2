...
- To run locally clone via the web url [https://github.com/DanteSenior/IFCS1summative1_task1-2.git](https://github.com/DanteSenior/IFCS1summative1_task1-2.git).
- Navigate to the repo and download as a ZIP.
- Or via git clone git@github.com:DanteSenior/IFCS1summative1_task1-2.git
